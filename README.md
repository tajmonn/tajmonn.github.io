...
The site is designed to be lightweight, fast, and minimalistic.
...
- **Custom web fonts (Nerd Fonts)**
- **No frameworks** – pure, simple, and fast
...
├── fonts/
│   ├── FiraMono.woff2
│   └── DepartureMonoNerdFont-Regular.woff2
├── icons/
│   └── icons and images on desktop
├── images/
│   └── screenshots and pictures
├── cursor/
│   └── custom retro cursors
├── markdown/
│   └── markdowns for each ".txt file"
└── README.md
```
---
